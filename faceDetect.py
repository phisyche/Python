...
def detect_and_draw(image):
    ...
    # haarlocation = 'C:\OpenCV2.3\opencv\data\haarcascades\haarcascade_frontalface_alt.xml' # Windows Example
    haarlocation = '/usr/share/OpenCV/haarcascades/haarcascade_frontalface_alt.xml' # Mac OS X example
